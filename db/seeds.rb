...
task1 = Task.create(description: Faker::Lorem.paragraph, status: "Open", category: Faker::Commerce.department, customer_id: user1.id, title: Faker::Company.catch_phrase, budget: Faker::Number.number(1), location: Faker::Address.city)
task2 = Task.create(description: Faker::Lorem.paragraph, status: "Open", category: Faker::Commerce.department, customer_id: user2.id, title: Faker::Company.catch_phrase, budget: Faker::Number.number(1), location: Faker::Address.city)
task3 = Task.create(description: Faker::Lorem.paragraph, status: "Open", category: Faker::Commerce.department, customer_id: user3.id, title: Faker::Company.catch_phrase, budget: Faker::Number.number(1), location: Faker::Address.city)
task4 = Task.create(description: Faker::Lorem.paragraph, status: "Open", category: Faker::Commerce.department, customer_id: user4.id, title: Faker::Company.catch_phrase, budget: Faker::Number.number(1), location: Faker::Address.city)
...
task5.proposals << proposal5
task6.proposals << proposal6
task7.proposals << proposal7
